    ...
    >
      ...
      >
        ...
        >
          ...
          <h1 className="text-center font-bold capitalize tracking-[1px] text-[#ff7a2f] xl:text-[100px] lg:text-[80px] md:text-[60px] sm:text-[54px] text-[44px] md:tracking-[4px] text-heading">
