    ...
    <section className="relative text-white">
      <div className="relative min-h-[90vh] z-10 mx-auto flex container items-center justify-between gap-16 px-6 py-10 md:px-14 xl:px-20">
        <div className="flex flex-col">
          <p className="m-0 text-[18px] font-medium uppercase tracking-[5px] text-[#ff7a2f]">What I do</p>
          <div className="text-[54px] font-bold text-white xl:mb-15 md:mb-10 mb-5">Services</div>

          <div className="grid xl:grid-cols-3 md:grid-cols-2 gap-6">
            {
              data.map((item: Data, index: number) => {
                return <div key={index} className="bg-gray-800 p-7 rounded-xl">
                  ...
                  <span className="text-[24px] font-medium font-semibold text-white mb-4 block">{item?.title}</span>
